...
plt.xlabel(r"$\tau$")
plt.savefig(f"{figures_dir}/{algorithm}_tau_histogram_env_2.pdf", bbox_inches="tight")
plt.close()
#plotting force
...
plt.ylabel("Frequency")
plt.xlabel(r"$f$")
plt.savefig(f"{figures_dir}/{algorithm}_force_histogram_env_2.pdf", bbox_inches="tight")
plt.close()
algorithm = 'rrt_star'
